/*
  # Replace search_visit_tests function to include doctor_viewed_at

  Drops and recreates the search function to add the doctor_viewed_at column,
  which is needed by the TestResults page.
*/

DROP FUNCTION IF EXISTS search_visit_tests(text, text, integer, integer);
